...
useEffect(() => {
    ...
    // ✅ SIRF CLEANUP RETURN KARO — isLoading wala block hatao
    return () => {
        blinkAnimation.stop();
    ...
    if (typeof BottomNav !== "function" || typeof DrawerMenu !== "function")
        ...
        // ✅ YEH SAHI JAGAH HAI — return se bilkul pehle
    if (isLoading) {
        return (
            <View style={{ 
                flex: 1, 
                ...
                alignItems: "center",
                backgroundColor: "#1E1111"  // App ka dark background
            }}>
                <Text style={{ color: "#EC9A15", fontSize: 16 }}>
                    Loading...
                </Text>
            </View>
        );
