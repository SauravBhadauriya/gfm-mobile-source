...
export default function TikTokCameraScreen() {
    ...
    const [selectedCameraFormat, setSelectedCameraFormat] =
        useState<CameraFormat>({
            resolution: "HD",
            frameRate: 30,
            color: "SDR",
        });
    ...
    const startRecording = async () => {
        ...
        const maxDuration =
            maxRecordingDuration > 0 ? maxRecordingDuration : 60;
    ...
    const handleNext = () => {
        if (recordedClips.length === 0) {
            Alert.alert(
                "No Clips",
                "Please record at least one clip before proceeding.",
            );
            return;
        }
            ...
            onPanResponderMove: (evt, gestureState) => {
                if (isRecording) {
                    ...
                    const relativeX = Math.max(
                        0,
                        Math.min(sliderWidth, gestureState.moveX - startX),
                    );
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.overlay}>
                ...
                <Animated.View
                    style={[styles.leftToolbar, { opacity: toolbarOpacity }]}
                >
                    <TouchableOpacity
                        ...
                        <TouchableOpacity
                            ...
                            onPress={() => {
                                if (musicButtonRef.current) {
                                    musicButtonRef.current.measureInWindow(
                                        (x, y, w, h) => {
                                            setMusicPopupPos({
                                                x: x - 80,
                                                y: y + h + 8,
                        ...
                        <TouchableOpacity
                            ...
                            onPress={() => {
                                if (hdButtonRef.current) {
                                    hdButtonRef.current.measureInWindow(
                                        (x, y, w, h) => {
                                            setHDPopupPos({
                                                x: x + w + 8,
                                                y: y,
                ...
                >
                    ...
                    {!isRecording && (
                        <View
                            style={styles.zoomSelectorContainer}
                            ...
                            >
                                ...
                                <Animated.View
                                    style={{
                                        ...
                                        transform: [
                                            { translateX: zoomThumbTranslateX },
                                        ],
                                    }}
                                />
                            </View>
                                    ...
                                    return (
                                        <TouchableOpacity
                                            ...
                                            style={[
                                                ...
                                                selectedCameraFormat.resolution ===
                                                    res &&
                                                    styles.hdPopupOptionActive,
                                                !isSupported &&
                                                    styles.hdPopupOptionDisabled,
                                            ]}
                                            onPress={() => {
                                                if (isSupported) {
                                                    setSelectedCameraFormat(
                                                        (prev) => ({
                                                            ...prev,
                                                            resolution: res,
                                                        }),
                                        ...
                                        >
                                            <Text
                                                style={[
                                                    ...
                                                    selectedCameraFormat.resolution ===
                                                        res &&
                                                        styles.hdPopupOptionTextActive,
                                                    !isSupported &&
                                                        styles.hdPopupOptionTextDisabled,
                                                ]}
                                            >
                                                {res}
                                            </Text>
                                            ...
                                            >
                                                <Text
                                                    style={[
                                                        ...
                                                        selectedSpeed ===
                                                            speed &&
                                                            styles.smallPopupOptionTextActive,
                                                    ]}
                                                >
                                                    {speed}x
                                                </Text>
                ...
                >
                    ...
                    >
                        ...
                        >
                            <View style={styles.popupArrow} />
                            <View style={styles.smallPopupContent}>
                                {["Track 1", "Track 2", "Track 3", "None"].map(
                                    (track, index, array) => (
                                        <TouchableOpacity
                                            key={track}
                                            style={[
